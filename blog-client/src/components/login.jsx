...
function Login() {
  ...
  let error;
  if(isErrorOccurred){
    error = <h3 className="agency danger text-larger m-2 link-danger">Login or Password is wrong!</h3>;
  }
      return (
       <div className="base" style={{backgroundImage: "url(/drawable/loginBack.png)"}}>
          <div className="loginContainer col-5 d-flex flex-row align-items-center gap-3 bg-light">
            <div className="loginForm p-2 d-flex flex-column       justify-content-center align-items-center">
              ...
              <Link className="dark-link mt-3 mb-3 align-self-center text-center agency text-larger text-dark" to='/login'>Forgot password?</Link>
              
              <button className="btn bg-dark-color color-light w-100 yu-gothic opacity-button mt-2 mb-2 round-card d-flex ps-4 p-2 align-items-center">
                <img alt="G" src={window.location.protocol + '//' + window.location.host + '/drawable/google.png'} className="icon me-3"></img>
                Connect with Google</button>

              <button className="btn bg-dark-color color-light w-100 p-2 yu-gothic opacity-button mt-3 round-card d-flex ps-4 p-2 align-items-center">

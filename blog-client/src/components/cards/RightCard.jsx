...
function RightCard(props) {
    return (
        <div className="card parent border-0 round-button d-flex flex-column align-items-baseline justify-content-end ms-3 me-3 opacity-trigger shadow" style={{
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="child" viewBox="0 15 673.859 261.918" style={{
                position: 'absolute',
                top: '143.5px',
            ...
            <div className="opacity-trigger child" style={{
                ...
                <h3 className="agency fs-2 me-4 color-light ms-4 mt-4 opacity-trigger" style={{ maxHeight: '110px' }} >{props.article.title}</h3>
                <h5 className="agency fs-5 color-sub-light ms-4 ps-3 mt-2 mb-2" style={{
                }}>
                    by {props.author}
                </h5>
            </div>

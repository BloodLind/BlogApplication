...
function LeftCard(){
    return (
    <div className="card round-card ms-5 me-5 opacity-trigger" style={{
        ...
        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 663.387 371.949">
...
<div className="opacity-trigger" style={{
        ...
        <Link className="btn bg-accent color-light yu-gothic text-large round-button m-3 me-5 col-3 opacity-button hidden align-self-end" to="/article"
        style={{
            position:'relative',
            width:'110px',
            height:'40px',
